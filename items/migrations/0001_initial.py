    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_image1', models.ImageField(default=None, null=True, upload_to='images/')),
                ('item_image2', models.ImageField(default=None, null=True, upload_to='images/')),
                ('item_image3', models.ImageField(default=None, null=True, upload_to='images/')),
            ],
            options={
                'ordering': ['createdAt'],
            },
